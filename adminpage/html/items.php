            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4 text-right">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#newItemMod">Add New</button>
                    </div>
                </div><br>
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                            ...
                            $columns1   = [ "Item_Id", "Item_name", "Item_price", "Item_img", "Date_added", "Time_added" ];
                            $where1     = [ "Status" => 1 ];
                            $orderBy1   = "Date_added DESC, Time_added DESC "; 

                            $fetch1     = get('items', $columns1, $where1, $orderBy1);

                            foreach($fetch1 as $row){

                                $banner_Id   = $row["Item_Id"];
                                $banner_head = $row["Item_name"];
                                $banner_body = $row["Item_price"];
                                $banner_img  = $row["Item_img"];
                                ...
                                echo "<tr>
                                        ...
                                        <td>
                                            <button type='button' class='btn btn-danger' onclick='deleteItem(`".$banner_Id."`)'>
